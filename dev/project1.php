...
<<<<<<< HEAD
								<p>After having the initial designs approved, we moved into the development stage, which is generally my favourite part. I used SASS for this project which was very helpful to keep the fonts, colours and mixins consistent. Developing the website, I used such libraries as JQuery for creation of filter on Practice area page and modal navigation bar, and Slick Slider library for sliders in the Testimonials section on the main page. Contact form is written using PHP.</p>
=======
...
>>>>>>> 6d963a3d8a60612fe563e386383b8978752eb155
							</div>
							<div class="slick-slider">
