...
<button class="btn filter-button" onclick="filterSelection('shopify')">Shopify</button>
...
<button class="btn filter-button" onclick="filterSelection('photoshop')">Adobe Photoshop</button>
