		...
		<main>
			<div class="container">
						...
						<section class="about-skills left-section animate__animated animate__fadeIn" id="skills">
							...
							<div class="all-cards" data-aos="zoom-in">
								...
								<div class="card-container">
										<div class="card">
											<a href="#0">
												<div class="card--display"><i class="fas fa-palette"></i>
													<h2>Web design</h2>
												</div>
												<div class="card--hover">
													<ul>
								...
								<div class="card-container">
										<div class="card">
											<a href="#0">
												<div class="card--display"><i class="fas fa-laptop-code"></i>
													<h2>CMS</h2>
												</div>
												<div class="card--hover">
													<ul>
								...
								<div class="card-container">
									<div class="card">
										<a href="#0">
											<div class="card--display"><i class="far fa-window-restore"></i>
												<h2>Other</h2>
											</div>
											<div class="card--hover">
												<ul>
				...
				<div class="right-side">
					<div class="about-me-right animate__animated animate__fadeIn animate__delay-1s">
